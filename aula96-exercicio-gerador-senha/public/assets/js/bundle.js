...
/* harmony import */ var _modules_GeradorSenha_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/GeradorSenha.js */ "./src/modules/GeradorSenha.js");
...
(function () {
  ...
  var geradorSenha = new _modules_GeradorSenha_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return GeradorSenha; });
...
var GeradorSenha = /*#__PURE__*/function () {
  ...
  _createClass(GeradorSenha, [{
    ...
    value: function gerarSenha() {
      ...
      for (var _letra = 97; _letra <= 122; _letra++) {
        lower.push(String.fromCharCode(_letra));
      }
      var elementsChecked = [];
      if (this.numbers) {
      ...
      if (elementsChecked.length > 0) {
        var numeroAleatorio = function numeroAleatorio(max) {
          return Math.floor(Math.random() * max);
        };
        for (var i = 0; i < this.caracteres; i++) {
          var randUm = numeroAleatorio(elementsChecked.length);
          var randDois = void 0;
    ...
    value: function mostraSenha() {
      var resultadoSenha = window.document.querySelector('.senha');
