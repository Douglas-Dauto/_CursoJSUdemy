...
(function () {
  ...
  var cpfGerado = window.document.querySelector('.cpf-gerado');
...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function geraNovoCPF() {
      ...
      var digitoUm = _ValidaCPF_js__WEBPACK_IMPORTED_MODULE_0__["default"].geraDigito(cpfSemDigito);
      var digitoDois = _ValidaCPF_js__WEBPACK_IMPORTED_MODULE_0__["default"].geraDigito(cpfSemDigito + digitoUm);
